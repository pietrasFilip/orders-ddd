package com.app.infrastructure.persistence.repository.order.json;
...
class FindAllJsonTest {
    ...
    @Autowired
    private OrderRepositoryJson orderRepositoryJson;

    @Test
    @DisplayName("When there are orders in json file")
    void test1() {
        var order1 = Order
                .builder()
                .id(1L)
        ...
        var foundOrders = orderRepositoryJson.findAll()
                .stream()
