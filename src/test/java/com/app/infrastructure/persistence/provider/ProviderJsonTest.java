...
@TestPropertySource(locations = "classpath:application-test.properties", properties = "processor.orders.type=JSON")
class ProviderJsonTest {
    ...
    @Test
    @DisplayName("When processor.orders.type is json")
    void test1() {
